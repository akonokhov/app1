...
workflow_runs = []
timeout_seconds = os.getenv('TIMEOUT_SECONDS', default=1800)
...
# Wait till status of all workflow runs is 'completed'
for w in workflow_runs:
    print("Waiting for the workflow: id={}, run_number={}, status={}".format(w['id'], w['run_number'], w['status']))
